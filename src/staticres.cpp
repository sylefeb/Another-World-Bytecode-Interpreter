...
const StrEntry Video::_stringsTableEng[] = {
  ...
  { 0x190, "Welcome back professor.\n2023, we are now in the future!" },
	// { 0x191, "I see you have driven here in your\nFerrari." },
     { 0x191, "I see you still have your Ferrari.\nNothing beats a good retro-classic!" },
	// { 0x192, "IDENTIFICATION" },
  { 0x192, "Happy New Year!" },
